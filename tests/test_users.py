...
def test_get_users(create_role, sign_up, test_client):
    ...
    test_client.post('/api/v1/auth/sign-up/', json=user_create_3)
...
def test_unauthenticated_users(create_role, sign_up, test_client):
...
def test_get_followers(create_role, sign_up, test_client):
    ...
    res = test_client.get(
        f'/api/v1/users/{user_create_2.get('username')}/followers/',
        headers={'Authorization': f'Bearer {sign_in_res.json()['access_token']}'},
    )
...
def test_get_followings(create_role, sign_up, test_client):
    ...
    res = test_client.get(
        f'/api/v1/users/{user_create_2.get('username')}/followings/',
        headers={'Authorization': f'Bearer {sign_in_res.json()['access_token']}'},
    )
...
def test_upload_image(create_role, sign_up, test_client):
    ...
    img_path = Path(settings.PROFILE_IMAGE_PATH).resolve() / '20240811_012037.jpg'
...
def test_get_user_posts(create_role, sign_up, create_post, test_client):
    ...
    res = test_client.get(
        f'/api/v1/users/{user_create_1.get('username')}/posts/',
        headers={'Authorization': f'Bearer {sign_in_res.json()['access_token']}'},
    )
...
def test_get_user_comments(create_role, sign_up, create_post, test_client):
    ...
    res = test_client.get(
        f'/api/v1/users/{user_create_1.get('username')}/posts/comments/',
        headers={'Authorization': f'Bearer {sign_in_res.json()['access_token']}'},
    )
...
def test_get_liked_posts(create_role, sign_up, create_post, test_client):
    ...
    res = test_client.get(
        f'/api/v1/users/{user_create_1.get('username')}/posts/likes/',
        headers={'Authorization': f'Bearer {sign_in_res.json()['access_token']}'},
    )
